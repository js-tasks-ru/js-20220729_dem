...
export default class ProductForm {
      ...
      <form data-element="productForm" class="form-grid">
        ...
        <div class="form-group form-group__wide" data-element="sortable-list-container">
          ...
          <div data-element="imageListContainer">
            ...
            ${this.productImagesContainerTemplate()}
            </ul>
          </div>
  ...
  appendImagesContainerItem({url, source}) {
    ...
    console.log(this.subElements.imageListContainer.querySelector(".sortable-list").outerHTML);
    this.subElements.imageListContainer.querySelector(".sortable-list").appendChild(itemWrapper.firstElementChild);
  }
  ...
  async fetchProduct() {
    ...
    return fetchJson(url)
      ...
      .catch(reason => console.error(`Failed to fetch product ${this.productId} data: ${reason}`));
  }
  ...
  async save() {
    const productFormData = this.formParams(Object.fromEntries(new FormData(this.subElements.productForm)));
    productFormData.id = this.productId;
    productFormData.images = this.formData.images;
    const jsonFormData = JSON.stringify(this.escapeHtmlValues(productFormData));

    if (this.productId) {
      await this.updateProduct(jsonFormData);
    } else {
      await this.createProduct(jsonFormData);
    }
  }
